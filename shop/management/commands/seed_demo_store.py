...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        samples = [
            ...
            {
                "category": ProductCategory.objects.get(slug="developer-gift-cards"),
                "title": "旗舰验收套餐（总面值 200 美元）",
                "slug": "enterprise-acceptance-pack-300usd",
                "summary": "人民币一次支付，获取总面值 US$200 的组合套餐，适合更高强度的企业验收。",
                "description": "适合验证大额支付、人工审核、回调稳定性和企业级交付场景下的持续压测。",
                "face_value": "200.00",
                "token_amount": 20000000,
                "price": "1398.00",
                "delivery_method": Product.DeliveryMethod.PARTNER_API,
                "provider_sku": "bundle-enterprise-200usd",
                "badge": "旗舰套餐",
                "cover_url": "https://images.unsplash.com/photo-1516321310764-8d1b9f1a8f32?auto=format&fit=crop&w=1200&q=80",
                "low_stock_threshold": 0,
            },
            {
                "category": ProductCategory.objects.get(slug="developer-gift-cards"),
                "title": "超大额压测套餐（总面值 300 美元）",
                "slug": "enterprise-acceptance-pack-500usd",
                "summary": "人民币一次支付，获取总面值 US$300 的组合套餐，适合高强度压测与长期联调。",
                "description": "适合验证超大额支付、订单对账、人工复核、供应稳定性以及长期使用场景下的联调能力。",
                "face_value": "300.00",
                "token_amount": 30000000,
                "price": "2068.00",
                "delivery_method": Product.DeliveryMethod.PARTNER_API,
                "provider_sku": "bundle-enterprise-300usd",
                "badge": "超大额",
