        ...
        samples = [
            {
                ...
                "summary": "用于验证小额支付、订单创建与支付成功回调是否连通。",
                "description": "适合做支付通道的第一轮冒烟测试，重点覆盖最小金额、回调落单和订单状态流转。",
                "face_value": "1.00",
                "token_amount": 100000,
                "price": "9.90",
            ...
            },
            {
                ...
                "summary": "用于验证带小数金额的支付显示、对账和退款链路。",
                "description": "适合测试支付页面金额展示、网关回传金额精度以及后续对账逻辑。",
                "face_value": "3.00",
                "token_amount": 300000,
                "price": "23.70",
                "delivery_method": Product.DeliveryMethod.STOCK_CARD,
            ...
            },
            {
                ...
                "summary": "适合联调支付回调、商户订单映射和异步通知重试。",
                "description": "由合作 API 平台自动供货，用于验证中额支付链路、支付回调和订单状态同步。",
                "face_value": "30.00",
            ...
            },
            {
                ...
                "summary": "用于验证大额支付、人工复核、风控提示和对账验收流程。",
                "description": "面向后期正式支付通道验收的高金额商品，适合测试大额下单、支付成功回调和人工审核环节。",
                "face_value": "200.00",
                "token_amount": 25000000,
                "price": "1368.00",
                "delivery_method": Product.DeliveryMethod.PARTNER_API,
                "provider_sku": "api-token-200usd",
                "badge": "大额验收",
                "cover_url": "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1200&q=80",
                "low_stock_threshold": 0,
            },
